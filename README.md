...
### 🐦 COBOL Nest — Modernisation
| Tool | Description | Repository |
|------|-------------|------------|
| Gullwing-Swan | COBOL → Python | [Repo](https://github.com/Chikimonki/Gullwing-Swan) |
| Gullwing-Tern | COBOL → Rust | [Repo](https://github.com/Chikimonki/Gullwing-Tern) |
| Gullwing-Skylark | COBOL → Python + Rust + DORA | [Repo](https://github.com/Chikimonki/Gullwing-Skylark) |

### 💰 Financial Nest — Identity & Audit
| Tool | Description | Repository |
|------|-------------|------------|
